...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-op_lt_bg px-5 md:px-20 lg:px-30 dark:bg-op_bg transition-colors duration-300">
        <section className='min-h-screen'>
          ...
          <div className="text-center">
            ...
            <p className="py-2 dark:text-gray-200 max-w-md mx-auto">
              Geared and Aimed to Work with AI. Currently a C | C++ and theoretically a FullStack Dev. 
              Working most of my time on Private Projects and also a Notorious Cry-Baby :P
            </p>
          </div>
        </section>
      </main>
